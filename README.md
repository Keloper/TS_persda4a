...
- [Быстрый запуск экспериментов](#-быстрый-запуск-экспериментов)
- [Генерация сабмитов для Kaggle](#-генерация-сабмитов-для-kaggle)
- [Методология и валидация](#-методология-и-валидация)
- [Результаты и эволюция моделей](#-результаты-и-эволюция-моделей)
- [Ключевые инсайты (Error Analysis)](#-ключевые-инсайты-error-analysis)
